...
public class KeyedProcessAlarmJobWithProcessTime {
    public static void main(String[] args) throws Exception {
        ...
        // 处理真正的报警流
        SingleOutputStreamOperator<SnAlaram> process1 = process.getSideOutput(alramTag).keyBy(new KeySelector<SnAlaram, String>() {
            @Override
            public String getKey(SnAlaram snAlaram) throws Exception {
                return snAlaram.getSn();
            }
        }).process(new MyAlarmKeyedProcessFunction());
        process1.print();
